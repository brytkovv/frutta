...
@user_labeler.message(text=["Акции", get_locale("button.home_page.stock")])
...
@user_labeler.message(text=["Доставка", get_locale("button.home_page.delivery")])
...
@user_labeler.message(text=["Подарки", get_locale("button.home_page.presents")])
...
@user_labeler.message(text=["Десерты", get_locale("button.home_page.desserts")])
...
@user_labeler.message(text=["Часы работы", get_locale("button.home_page.working_hours")])
...
@user_labeler.message(text=["Отзывы", get_locale("button.home_page.feedback")])
